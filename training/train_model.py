...
def main():
    ...
    print(f"  Architecture: {MODEL_CFG.hidden_dims}  (6-layer backbone)")
    ...
    meta = {
        ...
        "dropout_head":  MODEL_CFG.dropout_head,
        ...
        "loss_mix":      f"{int(MODEL_CFG.alpha*100)}% CE(smooth={MODEL_CFG.label_smooth}) "
                         f"+ {int((1-MODEL_CFG.alpha)*100)}% MSE",
        "regularization":"Dropout 0.10 + BatchNorm + GradClip(1.0) + WD=1e-4",
