...
<div style="margin-bottom:0.8rem;">
  <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.3rem;">
    ...
    <h2 style="margin:0;font-family:'Plus Jakarta Sans',sans-serif;font-size:1.9rem;
               font-weight:800;color:#0F172A;letter-spacing:-0.02em;">Habit Tracker</h2>
  </div>
  <div style="height:3px;width:60px;background:linear-gradient(90deg,#1A56DB,#7C3AED);
              border-radius:2px;margin-bottom:0.5rem;"></div>
  <p style="color:#475569;font-size:0.96rem;margin:0;font-weight:500;">Track daily actions, streaks, and behavioral progress</p>
</div>
...
with col_log:
    ...
    streak_color = "#1A56DB" if streak >= 7 else "#FFB703" if streak >= 3 else "#64748B"
    st.markdown(f"""
    <div class="da-card" style="text-align:center;margin-top:0.5rem;">
      <div style="font-size:0.7rem;color:#475569;font-weight:700;margin-bottom:0.5rem;">CURRENT STREAK</div>
      <div style="font-size:3.5rem;font-weight:800;color:{streak_color};">{streak}</div>
      <div style="color:#475569;font-size:0.85rem;">consecutive days</div>
        ...
        <div class="da-card" style="margin-top:0.5rem;">
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.75rem;">
            <div style="text-align:center;">
              <div style="font-size:1.5rem;font-weight:800;color:#1A56DB;">{total_logs}</div>
              <div style="font-size:0.75rem;color:#475569;">Total Logs</div>
            </div>
            <div style="text-align:center;">
              <div style="font-size:1.5rem;font-weight:800;color:#D97706;">{rate:.0f}%</div>
              <div style="font-size:0.75rem;color:#475569;">Completion Rate</div>
            </div>
          </div>
        </div>
        """, unsafe_allow_html=True)
...
with col_stats:
    ...
    if history:
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;
          ...
          <div style="font-weight:700;color:#0F172A;">No analysis history yet</div>
    ...
    <div class="da-card da-card-violet" style="margin-top:0.5rem;">
      <div style="font-weight:700;margin-bottom:0.5rem;">💡 Streak Science</div>
