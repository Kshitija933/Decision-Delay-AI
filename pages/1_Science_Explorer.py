...
<div style="margin-bottom:1.5rem;">
  <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.3rem;">
    ...
    <h2 style="margin:0;font-family:'Plus Jakarta Sans',sans-serif;font-size:1.9rem;
               font-weight:800;color:#E2E8F0;letter-spacing:-0.02em;">Science Explorer</h2>
  </div>
  <div style="height:3px;width:60px;background:linear-gradient(90deg,#38BDF8,#A78BFA);
              border-radius:2px;margin-bottom:0.5rem;"></div>
  <p style="color:#94A3B8;font-size:0.96rem;margin:0;font-weight:500;">The cognitive science behind why humans delay action</p>
</div>
</div>
...
with tab1:
    ...
    with col1:
        ...
        <div class="da-card da-card-accent">
          <h3 style="margin:0 0 0.75rem;font-size:1.1rem;color:#E2E8F0;">The Action Gap</h3>
        ...
        <div class="da-card da-card-amber">
          <h3 style="margin:0 0 0.75rem;font-size:1.1rem;color:#E2E8F0;">🧠 Temporal Motivation Theory</h3>
          <p style="color:#CBD5E1;line-height:1.7;">
            Steel (2007) formalized procrastination as:
          </p>
          <div style="background:rgba(56,189,248,0.08);border:1px solid rgba(56,189,248,0.25);border-radius:8px;padding:1rem;margin:0.75rem 0;font-family:'JetBrains Mono',monospace;font-size:0.9rem;color:#67E8F9;">
        ...
        <div class="da-card da-card-violet">
          <h3 style="margin:0 0 0.75rem;font-size:1.1rem;color:#E2E8F0;">🎯 BJ Fogg's Behavior Model</h3>
          <p style="color:#CBD5E1;line-height:1.7;">
          ...
          <div style="display:flex;gap:0.75rem;margin-top:0.75rem;">
            <div style="flex:1;background:rgba(56,189,248,0.10);border:1px solid rgba(56,189,248,0.25);border-radius:8px;padding:0.75rem;text-align:center;">
              <div style="color:#38BDF8;font-weight:700;font-size:1.2rem;">M</div>
              <div style="color:#94A3B8;font-size:0.75rem;margin-top:0.25rem;">Motivation</div>
            </div>
            <div style="flex:1;background:rgba(167,139,250,0.10);border:1px solid rgba(167,139,250,0.25);border-radius:8px;padding:0.75rem;text-align:center;">
              <div style="color:#A78BFA;font-weight:700;font-size:1.2rem;">A</div>
              <div style="color:#94A3B8;font-size:0.75rem;margin-top:0.25rem;">Ability</div>
            </div>
            <div style="flex:1;background:rgba(252,211,77,0.10);border:1px solid rgba(252,211,77,0.25);border-radius:8px;padding:0.75rem;text-align:center;">
              <div style="color:#FCD34D;font-weight:700;font-size:1.2rem;">P</div>
              <div style="color:#94A3B8;font-size:0.75rem;margin-top:0.25rem;">Prompt</div>
            </div>
          </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div class="da-card">
          <div style="font-size:0.7rem;color:#67E8F9;letter-spacing:0.1em;font-weight:700;margin-bottom:1rem;">
            KEY STATISTICS
          </div>
        """, unsafe_allow_html=True)
        stats = [
        ...
        for num, desc in stats:
            st.markdown(f"""
            <div style="margin-bottom:1rem;padding-bottom:1rem;border-bottom:1px solid rgba(110,231,247,0.08);">
              <div style="font-size:1.8rem;font-weight:800;color:#38BDF8;">{num}</div>
              <div style="color:#94A3B8;font-size:0.82rem;margin-top:0.15rem;">{desc}</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        <div class="da-card da-card-rose" style="margin-top:0.5rem;">
          <h4 style="margin:0 0 0.75rem;font-size:0.95rem;color:#E2E8F0;">No Sensors. No Surveillance.</h4>
          <p style="color:#CBD5E1;font-size:0.82rem;line-height:1.6;">
...
with tab2:
    ...
    causes_data = [
        {
            "icon": "😨", "name": "Fear of Failure", "color": "#FB7185",
        ...
        {
            "icon": "🌀", "name": "Overwhelm / Complexity", "color": "#FCD34D",
        ...
        {
            "icon": "⏳", "name": "Lack of Immediate Reward", "color": "#38BDF8",
        ...
        {
            "icon": "🔁", "name": "Past Failure Loop", "color": "#A78BFA",
        ...
        {
            "icon": "🎯", "name": "Perfectionism", "color": "#FB923C",
        ...
        {
            "icon": "🧩", "name": "Decision Fatigue", "color": "#67E8F9",
    ...
    for i, c in enumerate(causes_data):
        ...
        with target:
            ...
            <div class="da-card" style="border-left:3px solid {c['color']}">
              ...
              <p style="color:#CBD5E1;font-size:0.82rem;line-height:1.6;margin:0 0 0.75rem;">{c['desc']}</p>
              <div style="margin-bottom:0.5rem;">
                <div style="font-size:0.7rem;color:#67E8F9;font-weight:700;margin-bottom:0.3rem;">TRIGGERS</div>
                <div>{''.join(f'<span class="stat-pill">{t}</span>' for t in c['triggers'])}</div>
              </div>
              <div style="margin-top:0.75rem;padding-top:0.75rem;border-top:1px solid rgba(110,231,247,0.08);">
                <div style="font-size:0.7rem;color:#67E8F9;font-weight:700;">INTERVENTION</div>
...
with tab3:
    st.markdown("""
    <div class="da-card da-card-accent">
      <h3 style="margin:0 0 1rem;font-size:1.1rem;color:#E2E8F0;">Model Input→Output Framework</h3>
    """, unsafe_allow_html=True)

    col1, col2, col3 = st.columns(3, gap="medium")
    with col1:
        st.markdown("""
        <div style="background:rgba(56,189,248,0.07);border:1px solid rgba(56,189,248,0.20);border-radius:10px;padding:1rem;">
          <div style="color:#38BDF8;font-weight:800;font-size:0.8rem;letter-spacing:0.1em;margin-bottom:0.75rem;">INPUTS</div>
          <div style="color:#CBD5E1;font-size:0.8rem;font-family:'JetBrains Mono',monospace;line-height:2;">
    ...
    with col2:
        st.markdown("""
        <div style="background:rgba(167,139,250,0.07);border:1px solid rgba(167,139,250,0.20);border-radius:10px;padding:1rem;">
          <div style="color:#A78BFA;font-weight:800;font-size:0.8rem;letter-spacing:0.1em;margin-bottom:0.75rem;">MODEL</div>
          <div style="color:#CBD5E1;font-size:0.78rem;line-height:1.8;">
            <div style="margin-bottom:0.5rem;padding:0.5rem;background:rgba(167,139,250,0.10);border-radius:6px;font-family:'JetBrains Mono',monospace;color:#E2E8F0;">
              Feature Engineering<br>↓<br>Shared Backbone<br>[128→64 neurons]<br>↓
            </div>
            <div style="display:flex;gap:0.5rem;">
              <div style="flex:1;background:rgba(167,139,250,0.10);border-radius:6px;padding:0.5rem;text-align:center;font-size:0.72rem;color:#E2E8F0;">
                Classifier Head
              </div>
              <div style="flex:1;background:rgba(167,139,250,0.10);border-radius:6px;padding:0.5rem;text-align:center;font-size:0.72rem;color:#E2E8F0;">
                Regressor Head
    ...
    with col3:
        st.markdown("""
        <div style="background:rgba(252,211,77,0.07);border:1px solid rgba(252,211,77,0.20);border-radius:10px;padding:1rem;">
          <div style="color:#FCD34D;font-weight:800;font-size:0.8rem;letter-spacing:0.1em;margin-bottom:0.75rem;">OUTPUTS</div>
          <div style="color:#CBD5E1;font-size:0.8rem;line-height:2;">
            <span style="color:#FB7185;">●</span> Delay Cause (6-class)<br>
            <span style="color:#38BDF8;">●</span> Severity Score (0-1)<br>
            <span style="color:#A78BFA;">●</span> Confidence Score<br>
            <span style="color:#FCD34D;">●</span> Class Probabilities<br>
            <span style="color:#67E8F9;">●</span> Behavioral Nudge
          </div>
        </div>
        """, unsafe_allow_html=True)
...
with tab4:
    ...
    for authors, title, journal in refs:
        ...
        <div class="da-card" style="margin-bottom:0.5rem;padding:0.75rem 1rem;">
          <div style="font-weight:700;font-size:0.85rem;color:#38BDF8;">{authors}</div>
          <div style="color:#E2E8F0;font-size:0.85rem;margin:0.2rem 0;">{title}</div>
          <div style="color:#94A3B8;font-size:0.78rem;font-style:italic;">{journal}</div>
        </div>
        """, unsafe_allow_html=True)